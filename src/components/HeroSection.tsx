  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/4 -right-20 w-80 h-80 bg-primary/5 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: "1s" }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left order-2 lg:order-1">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/10 backdrop-blur-sm mb-8 animate-fade-in">
              <span className="text-primary text-sm font-medium">MC | CX Trainer | Experience Creator</span>
            </div>
            ...
            {/* Description */}
            <p className="text-lg text-muted-foreground/80 mb-10 max-w-xl mx-auto lg:mx-0 leading-relaxed animate-fade-in" style={{ animationDelay: "0.3s" }}>
              Transforming events into unforgettable moments through masterful hosting, 
              empowering teams with exceptional customer experience training, 
              and crafting unique entertainment concepts.
            </p>
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-4 mt-16 animate-fade-in" style={{ animationDelay: "0.5s" }}>
          ...
          {/* Photo */}
          <div className="order-1 lg:order-2 flex justify-center animate-fade-in-right" style={{ animationDelay: "0.3s" }}>
            <div className="relative">
              {/* Animated rings */}
              <div className="absolute inset-0 rounded-full border-2 border-primary/20 animate-ping" style={{ animationDuration: "3s" }} />
              <div className="absolute inset-4 rounded-full border border-primary/10 animate-ping" style={{ animationDuration: "3s", animationDelay: "0.5s" }} />
              ...
              <div className="absolute -bottom-8 -left-8 w-16 h-16 bg-primary/10 rounded-full blur-xl animate-float" style={{ animationDelay: "1s" }} />
            </div>
          </div>
        </div>
      </div>
